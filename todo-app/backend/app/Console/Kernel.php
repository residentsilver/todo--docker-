...
use App\Console\Commands\TestSubscriptionReminders;
use App\Console\Commands\CheckReminderHistory;
...
class Kernel extends ConsoleKernel
{
    ...
    protected $commands = [
        SendReminders::class,
        TestSubscriptionReminders::class,
        CheckReminderHistory::class,
    ];
